...
const STRINGS = {
    tr: {
        ...
        steamPathPrompt: (def) => `\nSteam kütüphane yolunu giriniz (Varsayılan: ${def}): `,
        aboutToDoTitle: '\nBu uygulama şunları yapacaktır:',
        step1: (p) => `  1. Steam kütüphanenizi (${p}) tarayarak oyun (.exe) dosyalarını bulacaktır.`,
        ...
        scanComplete: '\nTarama Tamamlandı:',
        foundCount: (n) => `  Steam kütüphanenizde ${n} adet yeni oyun/exe dosyası bulundu.`,
        notesTitle: '\nÖnemli Notlar:',
        ...
        noNewGames: '\nSteam\'den eklenecek yeni oyun bulunamadı. Liste zaten güncel.',
    ...
    en: {
        ...
        steamPathPrompt: (def) => `\nEnter Steam library path (Default: ${def}): `,
        aboutToDoTitle: '\nThis application will:',
        step1: (p) => `  1. Scan your Steam library (${p}) to find game (.exe) files.`,
        ...
        scanComplete: '\nScan Complete:',
        foundCount: (n) => `  Found ${n} new game/exe file(s) in your Steam library.`,
        notesTitle: '\nImportant Notes:',
